...
class _AdapHighState extends State<AdapHigh> {
  ...
  FirebaseFirestore.instance.collection('users').where("adapLevel",isEqualTo: "High").where("faculty", isEqualTo: "Education").snapshots();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Education > High Adaptability'),
      ),
      body: StreamBuilder(
        stream: _usersStream,
