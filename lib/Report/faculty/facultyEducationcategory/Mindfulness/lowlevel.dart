...
class _MindLowState extends State<MindLow> {
  ...
  FirebaseFirestore.instance.collection('users').where("mindLevel",isEqualTo: "Low").where("faculty", isEqualTo: "Education").snapshots();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Education > Low Mindfulness'),
      ),
      body: StreamBuilder(
        stream: _usersStream,
