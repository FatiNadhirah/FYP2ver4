...
class _ComLowState extends State<ComLow> {
  ...
  FirebaseFirestore.instance.collection('users').where("comLevel",isEqualTo: "Low").where("faculty", isEqualTo: "Dentistry").snapshots();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Dentistry > Low Communication'),
      ),
      body: StreamBuilder(
        stream: _usersStream,
