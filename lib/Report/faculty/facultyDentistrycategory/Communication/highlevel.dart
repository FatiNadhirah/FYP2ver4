...
class _ComHighState extends State<ComHigh> {
  ...
  FirebaseFirestore.instance.collection('users').where("comLevel",isEqualTo: "High").where("faculty", isEqualTo: "Dentistry").snapshots();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Dentistry > High Communication'),
      ),
      body: StreamBuilder(
        stream: _usersStream,
