...
class _TeamLowState extends State<TeamLow> {
  ...
  FirebaseFirestore.instance.collection('users').where("teamLevel",isEqualTo: "Low").where("faculty", isEqualTo: "Dentistry").snapshots();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Dentistry > Low Teamwork'),
      ),
      body: StreamBuilder(
        stream: _usersStream,
