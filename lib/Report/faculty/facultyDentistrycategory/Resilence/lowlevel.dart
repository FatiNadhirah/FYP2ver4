...
class _ResiLowState extends State<ResiLow> {
  ...
  FirebaseFirestore.instance.collection('users').where("resiLevel",isEqualTo: "Low").where("faculty", isEqualTo: "Dentistry").snapshots();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Dentistry > Low Resitability'),
      ),
      body: StreamBuilder(
        stream: _usersStream,
