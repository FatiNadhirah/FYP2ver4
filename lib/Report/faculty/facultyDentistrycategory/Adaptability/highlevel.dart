...
class _AdapHighState extends State<AdapHigh> {
  ...
  FirebaseFirestore.instance.collection('users').where("adapLevel",isEqualTo: "High").where("faculty", isEqualTo: "Dentistry").snapshots();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Dentistry > High Adaptability'),
      ),
      body: StreamBuilder(
        stream: _usersStream,
