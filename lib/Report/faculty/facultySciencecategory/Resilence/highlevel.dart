...
class _ResiHighState extends State<ResiHigh> {
  ...
  FirebaseFirestore.instance.collection('users').where("resiLevel",isEqualTo: "High").where("faculty", isEqualTo: "Science").snapshots();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Science > High Resilience'),
      ),
      body: StreamBuilder(
        stream: _usersStream,
