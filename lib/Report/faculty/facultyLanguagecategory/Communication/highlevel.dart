...
class _ComHighState extends State<ComHigh> {
  ...
  FirebaseFirestore.instance.collection('users').where("comLevel",isEqualTo: "High").where("faculty", isEqualTo: "Language").snapshots();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Language > High Communication'),
      ),
      body: StreamBuilder(
        stream: _usersStream,
