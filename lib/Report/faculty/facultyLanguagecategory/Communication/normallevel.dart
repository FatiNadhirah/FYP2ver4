...
class _ComNormalState extends State<ComNormal> {
  ...
  FirebaseFirestore.instance.collection('users').where("comLevel",isEqualTo: "Normal").where("faculty", isEqualTo: "Language").snapshots();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Language > Normal Communication'),
      ),
      body: StreamBuilder(
        stream: _usersStream,
