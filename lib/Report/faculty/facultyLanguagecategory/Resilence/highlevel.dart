...
class _ResiHighState extends State<ResiHigh> {
  ...
  FirebaseFirestore.instance.collection('users').where("resiLevel",isEqualTo: "High").where("faculty", isEqualTo: "Language").snapshots();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Language > High Resilience'),
      ),
      body: StreamBuilder(
        stream: _usersStream,
