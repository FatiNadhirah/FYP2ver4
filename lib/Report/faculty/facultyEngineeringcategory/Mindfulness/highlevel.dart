...
class _MindHighState extends State<MindHigh> {
  ...
  FirebaseFirestore.instance.collection('users').where("mindLevel",isEqualTo: "High").where("faculty", isEqualTo: "Engineering").snapshots();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Engineering > High Mindfulness'),
      ),
      body: StreamBuilder(
        stream: _usersStream,
