...
class _ResiHighState extends State<ResiHigh> {
  ...
  FirebaseFirestore.instance.collection('users').where("resiLevel",isEqualTo: "High").where("faculty", isEqualTo: "Engineering").snapshots();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Engineering > High Resilience'),
      ),
      body: StreamBuilder(
        stream: _usersStream,
