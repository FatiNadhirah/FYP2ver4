...
class _TeamLowState extends State<TeamLow> {
  ...
  FirebaseFirestore.instance.collection('users').where("teamLevel",isEqualTo: "Low").where("faculty", isEqualTo: "Engineering").snapshots();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Engineering > Low Teamwork'),
      ),
      body: StreamBuilder(
        stream: _usersStream,
