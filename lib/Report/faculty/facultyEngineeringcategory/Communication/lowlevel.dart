...
class _ComLowState extends State<ComLow> {
  ...
  FirebaseFirestore.instance.collection('users').where("comLevel",isEqualTo: "Low").where("faculty", isEqualTo: "Engineering").snapshots();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Engineering > Low Communication'),
      ),
      body: StreamBuilder(
        stream: _usersStream,
