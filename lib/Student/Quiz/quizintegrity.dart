...
class quizInteg extends StatefulWidget {
  final int emoLength;
  final int emoMarks;
  ...
  final int adapMarks;
  const quizInteg({Key? key, required this.emoLength,required this.emoMarks,
  ...
  @override
  _quizIntegState createState() => _quizIntegState();
}

class _quizIntegState extends State<quizInteg> {

  final Stream<QuerySnapshot> _usersStream1 = FirebaseFirestore.instance.collection('QuestionList').where("category",isEqualTo: "Integrity").snapshots();
                ...
                Expanded(
                  child: IconButton(
                    onPressed: ()=> Navigator.of(context).push(PageTransition(
                      ...
                      child: quizEmo(creaMarks: widget.creaMarks, creaLength: widget.creaLength,
                ...
                Expanded(
                  child: IconButton(
                    onPressed: ()=> {Navigator.of(context).push(PageTransition(
                      ...
                      duration: Duration(milliseconds: 600),
                      reverseDuration: Duration(milliseconds: 600),
                      child: quizMind(integMarks: integMarks, integLength: integLength,
                                    ...
                                    Radio(
                                      ...
                                      onChanged: (value) {
                                        setState(() {
                                          ...
                                          noQuestion = index +1;
                                          currentIndex = index;
                                          integLength = snapshot.data!.docs.length;
