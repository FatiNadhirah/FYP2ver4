...
class quizMind extends StatefulWidget {
  ...
  final int adapMarks;
  const quizMind({Key? key, required this.integLength,required this.integMarks,
  ...
  @override
  _quizMindState createState() => _quizMindState();
}

class _quizMindState extends State<quizMind> {

  final Stream<QuerySnapshot> _usersStream1 = FirebaseFirestore.instance.collection('QuestionList').where("category",isEqualTo: "Mindfulness").snapshots();
                ...
                Expanded(
                  child: IconButton(
                    onPressed: ()=> Navigator.of(context).push(PageTransition(
                      ...
                      child: quizInteg(emoMarks: widget.emoMarks, emoLength: widget.emoLength,
                ...
                Expanded(
                  child: IconButton(
                    onPressed: ()=> {Navigator.of(context).push(PageTransition(
                        ...
                        duration: Duration(milliseconds: 600),
                        reverseDuration: Duration(milliseconds: 600),
                        child: quizResi(mindMarks: mindMarks, mindLength: mindLength,
                                    ...
                                    Radio(
                                      ...
                                      onChanged: (value) {
                                        setState(() {
                                          ...
                                          noQuestion = index +1;
                                          currentIndex = index;
                                          mindLength = snapshot.data!.docs.length;
